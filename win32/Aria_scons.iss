...
AppVerName=Aria Maestosa 1.4.13
VersionInfoVersion=1.4.13
AppPublisher=
...
Source: "C:\TDM-GCC-64\bin\libgcc_s_dw2-1.dll"; DestDir: "{app}"; Flags: ignoreversion
;Source: "C:\TDM-GCC-64\bin\mingwm10.dll"; DestDir: "{app}"; Flags: ignoreversion
